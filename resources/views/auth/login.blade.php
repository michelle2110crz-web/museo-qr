...
<head>
    ...
    <title>Iniciar Sesión - Museo</title>
    ...
    <div class="w-full max-w-md px-4">
        <div class="card-glass p-8">
            <div class="text-center">
                ...
                <p class="text-[#888] mt-2 text-sm">Inicia sesión para administrar</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="mt-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" class="input-dark" required autofocus>
                </div>

                <div class="mb-6">
                    <label class="block text-[#c49a6c] font-semibold text-sm mb-1">Contraseña</label>
            ...
            <!-- ✅ ENLACE DE REGISTRO PARA VISITANTES -->
            <p class="text-center text-[#666] text-sm mt-4">
                ¿Quieres visitar el museo? 
                <a href="{{ route('register.visitante') }}" class="text-[#c49a6c] hover:text-[#d4aa7c] font-semibold">
